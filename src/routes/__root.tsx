...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Unicorn Rubbers — Industrial Rubber Products Manufacturer" },
      { property: "og:description", content: "Precision-engineered rubber components for automotive, industrial, water, electrical and poultry sectors. Bulk & custom manufacturing." },
