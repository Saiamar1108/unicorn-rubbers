...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Unicorn Rubbers manufactures precision industrial rubber products — gaskets, O-rings, oil seals, bellows, bushes & custom moulded parts. 16+ years. Hyderabad, India." },
      ...
      { property: "og:description", content: "Unicorn Rubbers manufactures precision industrial rubber products — gaskets, O-rings, oil seals, bellows, bushes & custom moulded parts. 16+ years. Hyderabad, India." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Unicorn Rubbers — Industrial Rubber Products Manufacturer | Hyderabad" },
      { name: "twitter:description", content: "Unicorn Rubbers manufactures precision industrial rubber products — gaskets, O-rings, oil seals, bellows, bushes & custom moulded parts. 16+ years. Hyderabad, India." },
